...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)(0x48000018u + CYAPP_ECC_OFFSET))

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)(0x480000C4u + CYAPP_ECC_OFFSET))
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0), 0x2EDFu);
