// ======================================================================
// Bootloader_RPiSoC.v generated from TopDesign.cysch
// 08/20/2014 at 14:42
...
module USBFS_v2_70_0 (
	...
	cy_clock_v1_0
		#(.id("3fd1b131-5956-40d5-8d56-1fed6f37de8d/03f503a7-085a-4304-b786-de885b1c2f21"),
	...
	cy_psoc3_pins_v1_10
		#(.id("3fd1b131-5956-40d5-8d56-1fed6f37de8d/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3fd1b131-5956-40d5-8d56-1fed6f37de8d/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__BL_wait_net;
	wire [0:0] tmpIO_0__BL_wait_net;
	wire [0:0] tmpINTERRUPT_0__BL_wait_net;
	electrical [0:0] tmpSIOVREF__BL_wait_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("44906eef-7414-4079-8114-eb0c25d01ec7"),
		  ...
		  .width(1))
		BL_wait
		 (.oe(tmpOE__BL_wait_net),
		  .y({1'b0}),
		  .fb({Net_45}),
		  .io({tmpIO_0__BL_wait_net[0:0]}),
		  .siovref(tmpSIOVREF__BL_wait_net),
		  .interrupt({tmpINTERRUPT_0__BL_wait_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BL_wait_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
