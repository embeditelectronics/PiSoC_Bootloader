...
/* BOOT_LED */
#define BOOT_LED__0__INTTYPE CYREG_PICU12_INTTYPE0
#define BOOT_LED__0__MASK 0x01u
#define BOOT_LED__0__PC CYREG_PRT12_PC0
#define BOOT_LED__0__PORT 12u
#define BOOT_LED__0__SHIFT 0
#define BOOT_LED__AG CYREG_PRT12_AG
#define BOOT_LED__BIE CYREG_PRT12_BIE
#define BOOT_LED__BIT_MASK CYREG_PRT12_BIT_MASK
#define BOOT_LED__BYP CYREG_PRT12_BYP
#define BOOT_LED__DM0 CYREG_PRT12_DM0
#define BOOT_LED__DM1 CYREG_PRT12_DM1
#define BOOT_LED__DM2 CYREG_PRT12_DM2
#define BOOT_LED__DR CYREG_PRT12_DR
#define BOOT_LED__INP_DIS CYREG_PRT12_INP_DIS
#define BOOT_LED__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU12_BASE
#define BOOT_LED__MASK 0x01u
#define BOOT_LED__PORT 12u
#define BOOT_LED__PRT CYREG_PRT12_PRT
#define BOOT_LED__PRTDSI__DBL_SYNC_IN CYREG_PRT12_DBL_SYNC_IN
#define BOOT_LED__PRTDSI__OE_SEL0 CYREG_PRT12_OE_SEL0
#define BOOT_LED__PRTDSI__OE_SEL1 CYREG_PRT12_OE_SEL1
#define BOOT_LED__PRTDSI__OUT_SEL0 CYREG_PRT12_OUT_SEL0
#define BOOT_LED__PRTDSI__OUT_SEL1 CYREG_PRT12_OUT_SEL1
#define BOOT_LED__PRTDSI__SYNC_OUT CYREG_PRT12_SYNC_OUT
#define BOOT_LED__PS CYREG_PRT12_PS
#define BOOT_LED__SHIFT 0
#define BOOT_LED__SIO_CFG CYREG_PRT12_SIO_CFG
#define BOOT_LED__SIO_DIFF CYREG_PRT12_SIO_DIFF
#define BOOT_LED__SIO_HYST_EN CYREG_PRT12_SIO_HYST_EN
#define BOOT_LED__SIO_REG_HIFREQ CYREG_PRT12_SIO_REG_HIFREQ
#define BOOT_LED__SLW CYREG_PRT12_SLW

/* BOOT_MODE */
#define BOOT_MODE__0__INTTYPE CYREG_PICU15_INTTYPE0
#define BOOT_MODE__0__MASK 0x01u
#define BOOT_MODE__0__PC CYREG_IO_PC_PRT15_PC0
#define BOOT_MODE__0__PORT 15u
#define BOOT_MODE__0__SHIFT 0
#define BOOT_MODE__AG CYREG_PRT15_AG
#define BOOT_MODE__AMUX CYREG_PRT15_AMUX
#define BOOT_MODE__BIE CYREG_PRT15_BIE
#define BOOT_MODE__BIT_MASK CYREG_PRT15_BIT_MASK
#define BOOT_MODE__BYP CYREG_PRT15_BYP
#define BOOT_MODE__CTL CYREG_PRT15_CTL
#define BOOT_MODE__DM0 CYREG_PRT15_DM0
#define BOOT_MODE__DM1 CYREG_PRT15_DM1
#define BOOT_MODE__DM2 CYREG_PRT15_DM2
#define BOOT_MODE__DR CYREG_PRT15_DR
#define BOOT_MODE__INP_DIS CYREG_PRT15_INP_DIS
#define BOOT_MODE__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU15_BASE
#define BOOT_MODE__LCD_COM_SEG CYREG_PRT15_LCD_COM_SEG
#define BOOT_MODE__LCD_EN CYREG_PRT15_LCD_EN
#define BOOT_MODE__MASK 0x01u
#define BOOT_MODE__PORT 15u
#define BOOT_MODE__PRT CYREG_PRT15_PRT
#define BOOT_MODE__PRTDSI__CAPS_SEL CYREG_PRT15_CAPS_SEL
#define BOOT_MODE__PRTDSI__DBL_SYNC_IN CYREG_PRT15_DBL_SYNC_IN
#define BOOT_MODE__PRTDSI__OE_SEL0 CYREG_PRT15_OE_SEL0
#define BOOT_MODE__PRTDSI__OE_SEL1 CYREG_PRT15_OE_SEL1
#define BOOT_MODE__PRTDSI__OUT_SEL0 CYREG_PRT15_OUT_SEL0
#define BOOT_MODE__PRTDSI__OUT_SEL1 CYREG_PRT15_OUT_SEL1
#define BOOT_MODE__PRTDSI__SYNC_OUT CYREG_PRT15_SYNC_OUT
#define BOOT_MODE__PS CYREG_PRT15_PS
#define BOOT_MODE__SHIFT 0
#define BOOT_MODE__SLW CYREG_PRT15_SLW

/* USB_Bootloader_arb_int */
#define USB_Bootloader_arb_int__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define USB_Bootloader_arb_int__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define USB_Bootloader_arb_int__INTC_MASK 0x400000u
#define USB_Bootloader_arb_int__INTC_NUMBER 22u
#define USB_Bootloader_arb_int__INTC_PRIOR_NUM 7u
#define USB_Bootloader_arb_int__INTC_PRIOR_REG CYREG_NVIC_PRI_22
#define USB_Bootloader_arb_int__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define USB_Bootloader_arb_int__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* USB_Bootloader_bus_reset */
#define USB_Bootloader_bus_reset__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define USB_Bootloader_bus_reset__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define USB_Bootloader_bus_reset__INTC_MASK 0x800000u
#define USB_Bootloader_bus_reset__INTC_NUMBER 23u
#define USB_Bootloader_bus_reset__INTC_PRIOR_NUM 7u
#define USB_Bootloader_bus_reset__INTC_PRIOR_REG CYREG_NVIC_PRI_23
#define USB_Bootloader_bus_reset__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define USB_Bootloader_bus_reset__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* USB_Bootloader_Dm */
#define USB_Bootloader_Dm__0__INTTYPE CYREG_PICU15_INTTYPE7
#define USB_Bootloader_Dm__0__MASK 0x80u
#define USB_Bootloader_Dm__0__PC CYREG_IO_PC_PRT15_7_6_PC1
#define USB_Bootloader_Dm__0__PORT 15u
...
#define USB_Bootloader_Dm__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU15_BASE
#define USB_Bootloader_Dm__LCD_COM_SEG CYREG_PRT15_LCD_COM_SEG
#define USB_Bootloader_Dm__LCD_EN CYREG_PRT15_LCD_EN
#define USB_Bootloader_Dm__MASK 0x80u
#define USB_Bootloader_Dm__PORT 15u
...
#define USB_Bootloader_Dp__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU15_BASE
...
#define USB_Bootloader_Dp__PORT 15u
...
#define USB_Bootloader_Dp__SNAP CYREG_PICU_15_SNAP_15

/* USB_Bootloader_dp_int */
#define USB_Bootloader_dp_int__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define USB_Bootloader_dp_int__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define USB_Bootloader_dp_int__INTC_MASK 0x1000u
#define USB_Bootloader_dp_int__INTC_NUMBER 12u
#define USB_Bootloader_dp_int__INTC_PRIOR_NUM 7u
#define USB_Bootloader_dp_int__INTC_PRIOR_REG CYREG_NVIC_PRI_12
#define USB_Bootloader_dp_int__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define USB_Bootloader_dp_int__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* USB_Bootloader_ep_0 */
#define USB_Bootloader_ep_0__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define USB_Bootloader_ep_0__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define USB_Bootloader_ep_0__INTC_MASK 0x1000000u
#define USB_Bootloader_ep_0__INTC_NUMBER 24u
#define USB_Bootloader_ep_0__INTC_PRIOR_NUM 7u
#define USB_Bootloader_ep_0__INTC_PRIOR_REG CYREG_NVIC_PRI_24
#define USB_Bootloader_ep_0__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define USB_Bootloader_ep_0__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* USB_Bootloader_ep_1 */
#define USB_Bootloader_ep_1__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define USB_Bootloader_ep_1__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define USB_Bootloader_ep_1__INTC_MASK 0x01u
#define USB_Bootloader_ep_1__INTC_NUMBER 0u
#define USB_Bootloader_ep_1__INTC_PRIOR_NUM 7u
#define USB_Bootloader_ep_1__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define USB_Bootloader_ep_1__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define USB_Bootloader_ep_1__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* USB_Bootloader_ep_2 */
#define USB_Bootloader_ep_2__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define USB_Bootloader_ep_2__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define USB_Bootloader_ep_2__INTC_MASK 0x02u
#define USB_Bootloader_ep_2__INTC_NUMBER 1u
#define USB_Bootloader_ep_2__INTC_PRIOR_NUM 7u
#define USB_Bootloader_ep_2__INTC_PRIOR_REG CYREG_NVIC_PRI_1
#define USB_Bootloader_ep_2__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define USB_Bootloader_ep_2__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* USB_Bootloader_ord_int */
#define USB_Bootloader_ord_int__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define USB_Bootloader_ord_int__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define USB_Bootloader_ord_int__INTC_MASK 0x2000000u
#define USB_Bootloader_ord_int__INTC_NUMBER 25u
#define USB_Bootloader_ord_int__INTC_PRIOR_NUM 7u
#define USB_Bootloader_ord_int__INTC_PRIOR_REG CYREG_NVIC_PRI_25
#define USB_Bootloader_ord_int__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define USB_Bootloader_ord_int__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* USB_Bootloader_sof_int */
#define USB_Bootloader_sof_int__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define USB_Bootloader_sof_int__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define USB_Bootloader_sof_int__INTC_MASK 0x200000u
#define USB_Bootloader_sof_int__INTC_NUMBER 21u
#define USB_Bootloader_sof_int__INTC_PRIOR_NUM 7u
#define USB_Bootloader_sof_int__INTC_PRIOR_REG CYREG_NVIC_PRI_21
#define USB_Bootloader_sof_int__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define USB_Bootloader_sof_int__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
#define CY_PROJECT_NAME "pisoc_bootloader"
