...
{
    uint8 staticBits = (USB_Bootloader_Dp_DR & (uint8)(~USB_Bootloader_Dp_MASK));
    USB_Bootloader_Dp_DR = staticBits | ((uint8)(value << USB_Bootloader_Dp_SHIFT) & USB_Bootloader_Dp_MASK);
}
...
*
*  USB_Bootloader_Dp_DM_STRONG     Strong Drive 
*  USB_Bootloader_Dp_DM_OD_HI      Open Drain, Drives High 
*  USB_Bootloader_Dp_DM_OD_LO      Open Drain, Drives Low 
*  USB_Bootloader_Dp_DM_RES_UP     Resistive Pull Up 
*  USB_Bootloader_Dp_DM_RES_DWN    Resistive Pull Down 
*  USB_Bootloader_Dp_DM_RES_UPDWN  Resistive Pull Up/Down 
*  USB_Bootloader_Dp_DM_DIG_HIZ    High Impedance Digital 
*  USB_Bootloader_Dp_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
