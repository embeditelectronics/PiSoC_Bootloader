...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USB_Bootloader_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USB_Bootloader_DEVICE0_CONFIGURATION0_DESCR[41u] = {
...
*********************************************************************/
const uint8 CYCODE USB_Bootloader_STRING_DESCRIPTORS[157u] = {
/*********************************************************************
...
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'P', 0u,(uint8)'S', 0u,(uint8)'o', 0u,(uint8)'C', 0u,(uint8)'3', 0u,
 (uint8)' ', 0u,(uint8)'B', 0u,(uint8)'o', 0u,(uint8)'o', 0u,(uint8)'t', 0u,
 (uint8)'l', 0u,(uint8)'o', 0u,(uint8)'a', 0u,(uint8)'d', 0u,(uint8)'e', 0u,
 (uint8)'r', 0u,
/*********************************************************************
* String Descriptor: "Embedit Electronics"
*********************************************************************/
/* Descriptor Length                       */ 0x28u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'E', 0u,(uint8)'m', 0u,(uint8)'b', 0u,(uint8)'e', 0u,(uint8)'d', 0u,
 (uint8)'i', 0u,(uint8)'t', 0u,(uint8)' ', 0u,(uint8)'E', 0u,(uint8)'l', 0u,
 (uint8)'e', 0u,(uint8)'c', 0u,(uint8)'t', 0u,(uint8)'r', 0u,(uint8)'o', 0u,
 (uint8)'n', 0u,(uint8)'i', 0u,(uint8)'c', 0u,(uint8)'s', 0u,
/*********************************************************************
* String Descriptor: "PiSoC Bootloader"
*********************************************************************/
/* Descriptor Length                       */ 0x22u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'P', 0u,(uint8)'i', 0u,(uint8)'S', 0u,(uint8)'o', 0u,(uint8)'C', 0u,
 (uint8)' ', 0u,(uint8)'B', 0u,(uint8)'o', 0u,(uint8)'o', 0u,(uint8)'t', 0u,
 (uint8)'l', 0u,(uint8)'o', 0u,(uint8)'a', 0u,(uint8)'d', 0u,(uint8)'e', 0u,
 (uint8)'r', 0u,
/*********************************************************************/
...
*********************************************************************/
const uint8 CYCODE USB_Bootloader_SN_STRING_DESCRIPTOR[10] = {
...
*********************************************************************/
const uint8 CYCODE USB_Bootloader_HIDREPORT_DESCRIPTOR1[40u] = {
...
*********************************************************************/
const T_USB_Bootloader_TD CYCODE USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_RPT_TABLE[1u] = {
    {USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_BUF_SIZE,
    &USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_BUF[0u],
...
*********************************************************************/
const T_USB_Bootloader_TD CYCODE USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_RPT_TABLE[1u] = {
    {USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_BUF_SIZE,
    &USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_BUF[0u],
...
*                                        HID Class Descriptor
*********************************************************************/
const T_USB_Bootloader_LUT CYCODE USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_TABLE[5u] = {
    {0x00u,     &USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_RPT_TABLE},
    {0x00u,     &USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_RPT_TABLE},
    {0x00u,    NULL},
    {0x01u,     (const void *)&USB_Bootloader_HIDREPORT_DESCRIPTOR1[0]},
    {0x01u,     (const void *)&USB_Bootloader_DEVICE0_CONFIGURATION0_DESCR[18]}
};
...
*********************************************************************/
const T_USB_Bootloader_LUT CYCODE USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE0_TABLE[1u] = {
...
*********************************************************************/
const T_USB_Bootloader_EP_SETTINGS_BLOCK CYCODE USB_Bootloader_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[2u] = {
/* IFC  ALT    EPAddr bmAttr MaxPktSize Class ********************/
{0x00u, 0x00u, 0x01u, 0x03u, 0x0040u,   0x03u},
{0x00u, 0x00u, 0x82u, 0x03u, 0x0040u,   0x03u}
};
const uint8 CYCODE USB_Bootloader_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[1u] = {
0x03u
};
/*********************************************************************
...
*********************************************************************/
const T_USB_Bootloader_LUT CYCODE USB_Bootloader_DEVICE0_CONFIGURATION0_TABLE[4u] = {
...
*********************************************************************/
const T_USB_Bootloader_LUT CYCODE USB_Bootloader_DEVICE0_TABLE[2u] = {
...
*********************************************************************/
const T_USB_Bootloader_LUT CYCODE USB_Bootloader_TABLE[1u] = {
    ...
    ******************************************************************************/
    ...
    const uint8 CYCODE USB_Bootloader_MSOS_DESCRIPTOR[USB_Bootloader_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    ...
    const uint8 CYCODE USB_Bootloader_MSOS_CONFIGURATION_DESCR[USB_Bootloader_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 USB_Bootloader_idSerialNumberStringDescriptor[USB_Bootloader_IDSN_DESCR_LENGTH];
